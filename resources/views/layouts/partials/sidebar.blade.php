<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:hidden transition-width" aria-label="Sidebar">
          ...
          <ul class="pb-2 space-y-2">
            ...
            <li>
              ...
              <ul id="dropdown-crud" class="py-2 space-y-2">
                <li>
                  <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 bg-gray-100 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 ">Products</a>
                </li>
                <li>
                  <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 bg-gray-100 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 ">Users</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="#" class="flex items-center p-2 text-base text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 ">
            ...
            <li>
              ...
              <ul id="dropdown-playground" class="py-2 space-y-2 ">
                <li>
                  <a href="#" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Stacked</a>
                </li>
                <li>
